...
<div id="sidebar"><a href="{{route('admin.dashboard')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Question Answer</span> <span class="label label-important">2</span></a>
      <ul>

        <li><a href="{{route('admin.Answers.view')}}">View question</a></li>

      </ul>
    </li>
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>User Review</span> <span class="label label-important">2</span></a>
      <ul>

        <li><a href="{{route('admin.review.view')}}">View Review</a></li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Order Chart</span> <span class="label label-important">3</span></a>
      <ul>
