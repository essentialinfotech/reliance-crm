      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{route('admin.banner.add')}}" enctype="multipart/form-data" name="add_product" id="add_product" novalidate="novalidate">
             @csrf
