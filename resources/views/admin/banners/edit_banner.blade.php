                  ...
                  <table>
                    <tr>
                      <td>
                        ...
                        <input type="hidden" name="current_image" id="image" value="{{$bannerDetails->image}}">
                        @endif
                      </td>
                      <td>
                        @if(!empty($bannerDetails->image))
                        <img src="{{asset('/images/backend_images/banners/'.$bannerDetails->image)}}" style="width: 60px"> | <a href=""> Delete</a>
                        @endif
                      </td>
                    </tr>
                  </table>
